...
# Set Intake Goal
@app.route('/SetIntakeGoal', methods=['POST'])
def SetIntakeGoal():
    data = request.json
    user_id = data.get('user_id')
...
# Set Breakfast Data
@app.route('/SetBreakfastData', methods=['POST'])
...
# Set Lunch Data
@app.route('/SetLunchData', methods=['POST'])
def SetLunchData():
    data = request.json
    user_id = data.get('user_id')
    date = data.get('date')
...
# Set Dinner Data
@app.route('/SetDinnerData', methods=['POST'])
def SetDinnerData():
    data = request.json
    user_id = data.get('user_id')
    date = data.get('date')
...
# Set Total Data
@app.route('/SetTotalData', methods=['POST'])
def SetTotalData():
    data = request.json
    user_id = data.get('user_id')
    date = data.get('date')
...
@app.route('/GetIntakeGoal/<user_id>', methods=['GET'])
...
# Get Date Data
@app.route('/GetDateData/<user_id>/<date>', methods=['GET'])
...
# Get Breakfast Data
@app.route('/GetBreakfastData/<user_id>/<date>', methods=['GET'])
...
# Get Lunch Data
@app.route('/GetLunchData/<user_id>/<date>', methods=['GET'])
...
# Get Dinner Data
@app.route('/GetDinnerData/<user_id>/<date>', methods=['GET'])
...
# Get Total Data
@app.route('/GetTotalData/<user_id>/<date>', methods=['GET'])
...
@app.route('/GetRemainingIntake/<user_id>/<date>', methods=['GET'])
